...
public class NameWarning extends JFrame{
    ...
    public NameWarning() {
        ...
        // Enter Name Text
        ImageIcon ENTextIcon = new ImageIcon("NameTextWarning.png");
        Image ENImage = ENTextIcon.getImage().getScaledInstance(300, 85, Image.SCALE_SMOOTH);
        ImageIcon ENText = new ImageIcon(ENImage);
        Text = new JLabel("", ENText, JLabel.CENTER);
        Text.setBounds(89, 77, 300, 85); 
        this.add(Text);
